...
Defaults.defaultAllegiance = "undeclared"
Defaults.EMPTY_ALLEGIANCE_FILTER = "none";
Defaults.HUMAN_ALLEGIANCE_FILTER = "resistance";
Defaults.ZOMBIE_ALLEGIANCE_FILTER = "horde";

Defaults.globalChatName = "Global Chat";
Defaults.globalHumanChatName = "Resistance Chat";
Defaults.globalZombieChatName = "Horde Chat";
Defaults.gameAdminChatName = "Admins";
